...
Modified from Point Transformer - V3
===========================================================

**Original Project**: Point Transformer V3: Simpler, Faster, Stronger
**Source URL**: https://github.com/Pointcept/PointTransformerV3

Main Changes:
  - replaced BatchNorm with LayerNorm.
  - Added forward_per_point() for the Model of SS-HMR.
...
class PointTransformerV3(PointModule):
    ...
    def forward_per_point(self, x,start_neighs=None):
        ...
        B, N, _ = x.shape
        x = x.reshape(-1, 3).clone()

        grid_coord = torch.floor(x / torch.tensor(0.05).cuda()).type(torch.int)
        ...
        data_dict = dict(
            ...
            offset=torch.arange(1, B + 1, device=x.device) * N
        )
        ...
        return point["feat"].reshape(B, N, -1)
